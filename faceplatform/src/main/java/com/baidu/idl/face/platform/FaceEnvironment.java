...
final public class FaceEnvironment {
    ...
    public static final float VALUE_OCCLUSION = 0.9f;
    ...
    public static final int VALUE_CROP_FACE_SIZE = 500;

    public static final int VALUE_MIN_FACE_SIZE = 60;
    ...
    // 识别策略配置参数
    public static long TIME_TIPS_REPEAT = 6000L;//重复提示时间
    public static long TIME_MODULE = 0L;
    public static long TIME_DETECT_NO_FACE_CONTINUOUS = 5000L;//连续没有出现脸部时间
    public static long TIME_DETECT_MODULE = 120 * 1000L;
    public static long TIME_LIVENESS_MODULE = 120 * 1000L;
