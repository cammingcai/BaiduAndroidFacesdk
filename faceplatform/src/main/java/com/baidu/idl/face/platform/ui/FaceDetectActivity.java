...
public class FaceDetectActivity extends Activity implements
    ...
    protected ImageView mDetectView;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.baidu.idl.face.platform.R.layout.activity_face_detect_v3100);
        ...
        mDetectView = (ImageView) mRootView.findViewById(R.id.detect);
...
//        }
    ...
    private void saveImageSigle(HashMap<String, String> imageMap) {
        Set<Map.Entry<String, String>> sets = imageMap.entrySet();
        Bitmap bmp = null;
        mImageLayout.removeAllViews();
        for (Map.Entry<String, String> entry : sets) {
