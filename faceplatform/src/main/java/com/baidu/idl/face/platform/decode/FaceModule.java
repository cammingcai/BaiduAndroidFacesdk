...
//            Log.e(TAG, "clear tracker");
    ...
    public FaceModel detect(byte[] imageData, int imageWidth, int imageHeight) {
        //detect imageData=[B@4225b120===imageData lenght=629856
       //  detect imageWidth=864---- imageHeight=486
        Log.i(TAG,"bitmap imageData="+imageData);
        // if(mDegree==0){
//            Bitmap bitmap  =  BitmapUtils.runInPreviewFrame(imageData,imageWidth,imageHeight);
//            Bitmap bitmapRotate = BitmapUtils.rotateBitmap(mDegree,bitmap);
//            byte[] dataCopy =  BitmapUtils.bitmapToByte(bitmapRotate);
//
//            Log.i(TAG,"bitmap dataCopy="+dataCopy+",length="+dataCopy.length);
//            Log.i(TAG,"bitmap bitmap="+bitmap);
//             imageData = dataCopy;
         // }

       // Log.i(TAG,"detect imageData="+imageData+"===imageData lenght="+imageData.length);
       // Log.i(TAG,"detect imageWidth="+imageWidth+"---- imageHeight="+imageHeight);
...
//            }
          ...
          //  Log.i(TAG,"faceInfos="+faceInfos);
           // Log.i(TAG,"getExtInfo(faceInfos)="+getExtInfo(faceInfos));
            ...
            //Log.i(TAG,"detect mArgbData="+mArgbData);
        }
        return model;
    }
...
//            }
           ...
           // Log.i(TAG,"liveness mArgbData="+mArgbData);
        }
        return model;
    }
...
//        Log.e(TAG, "decode status " + status.name());
    ...
    public String getDetectBestImage(int faceId) {
        ...
        Log.i(TAG, "faceVerifyDatas= " + faceVerifyDatas);
